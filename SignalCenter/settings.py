"""
Django settings for SignalCenter project.
...
ROOT_URLCONF = 'SignalCenter.urls'
...
# WSGI_APPLICATION = 'SignalCenter.wsgi.application'
ASGI_APPLICATION = 'SignalCenter.asgi.application'
